    ...
    server: {
      ...
      https: hasDevCertificate
        ? {
            ...
            passphrase: env.VITE_HTTPS_PASSPHRASE || 'signlink-dev'
          }
        : undefined,
      proxy: {
        '/api': {
          target: env.VITE_BACKEND_PROXY_TARGET || 'http://127.0.0.1:5001',
          changeOrigin: true,
          secure: false
        },
        '/socket.io': {
        ...
        '/landmark-api': {
          target: env.VITE_LANDMARK_PROXY_TARGET || 'http://127.0.0.1:8000',
          changeOrigin: true,
          secure: false,
